...
\begin{frame}{Objective Function}
    \begin{itemize}
        ...
        \item Use $\deg(\Delta_K(t))$ as a numeric measure of complexity.
...
\begin{frame}{Objective Function}
    \begin{align}
        ...
        &: T\mapsto \frac{1}{|E(T)|}\sum_{e\in E(T)} \deg{(\Delta_e(t))}
    \end{align}
...
\begin{frame}{MCMC}
    \begin{figure}
        ...
        \caption{Log histogram of MCMC Samples for the score function with power law fit.}
