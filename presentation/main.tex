...
% --- Preamble Settings ---
\definecolor{textgreen}{HTML}{013d1e}
\definecolor{backgreen}{HTML}{e6f0eb}


\usetheme{Boadilla}
\usecolortheme{spruce}
\beamertemplatenavigationsymbolsempty
\setbeamercolor{block title}{bg=backgreen, fg=textgreen}
\setbeamercolor{block body}{bg=black!5, fg=black}
\useoutertheme{default}
\setbeamercolor{footlinecolor}{bg=white, fg=black}

\setbeamertemplate{itemize item}[triangle]
\setbeamercolor{itemize item}{fg=textgreen!50}
\setbeamercolor{structure}{fg=textgreen}
...
\institute[USYD]{
    \textbf{Supervisor}: Jonathan Spreer \\
    \vspace{0.5cm}\\
