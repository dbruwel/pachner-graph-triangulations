...
All but $\mathcal{O}_{var}$ present power law distributed tails, to confirm this we compute $x_{\min}$ according to the procedure of Clauset, Shalizi, and Newman, and fit the distribution with MLE. A plot on a log-log histogram of the data, and the fitted distribution is seen in figure~\ref{fig:mcmc-score-dist-log}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{thesis/figures/}
        \caption{$\mathcal{O}_{deg}$}
        \label{fig:drect-ascent-all-deg}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{thesis/figures/}
        \caption{$\mathcal{O}_{det}$}
        \label{fig:drect-ascent-all-det}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \includegraphics[width=\textwidth]{thesis/figures/}
        \caption{$\mathcal{O}_{norm}$}
        \label{fig:drect-ascent-all-norm}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{thesis/figures/}
        \caption{$\mathcal{O}_{gen}$}
        \label{fig:drect-ascent-all-gen}
    \end{subfigure}
